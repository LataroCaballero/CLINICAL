...
The keys live in `.claude/settings.json` (project) or `/Users/laucaballero/Desktop/Lautaro/AndesCode/CLINICAL/.claude/settings.json` (global) — **not** in `.planning/config.json`:
