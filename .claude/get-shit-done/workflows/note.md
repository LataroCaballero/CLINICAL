...
- **Global scope**: `/Users/laucaballero/Desktop/Lautaro/AndesCode/CLINICAL/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/laucaballero/Desktop/Lautaro/AndesCode/CLINICAL/.claude/notes/`)
...
2. Glob `/Users/laucaballero/Desktop/Lautaro/AndesCode/CLINICAL/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/laucaballero/Desktop/Lautaro/AndesCode/CLINICAL/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/laucaballero/Desktop/Lautaro/AndesCode/CLINICAL/.claude/notes/` — works in any directory
