...
INSTALL_JS_GLOBAL="/Users/laucaballero/Desktop/Lautaro/AndesCode/CLINICAL/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/laucaballero/Desktop/Lautaro/AndesCode/CLINICAL/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
