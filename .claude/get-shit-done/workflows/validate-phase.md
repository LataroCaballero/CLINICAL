...
```
Agent(
  prompt="Read /Users/laucaballero/Desktop/Lautaro/AndesCode/CLINICAL/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/laucaballero/Desktop/Lautaro/AndesCode/CLINICAL/.claude/get-shit-done/templates/VALIDATION.md`
