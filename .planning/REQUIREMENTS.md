...
- [x] **CAEA-03**: Sistema informa facturas CAEA a AFIP dentro del plazo de 8 días calendario via job BullMQ con 72 reintentos distribuidos en la ventana
...
| CAE-02 | Phase 17 + Phase 19 | Complete (primary); Pending (secondary surface) |
| CAE-03 | Phase 18 | Complete |
...
- Mapped to phases: 16
- Unmapped: 0 ✓
- Pending (gap closure): CAE-03 → Phase 18; CAE-02 secondary surface → Phase 19
