...
- [x] **PORTAL-02**: El portal presenta la información paso a paso (wizard), claro y mobile-first, operable por un paciente no técnico
- [x] **PORTAL-03**: En "Información básica", el paciente revisa y corrige/completa sus datos personales de contacto (teléfono, email, dirección, contacto de emergencia)
- [x] **PORTAL-04**: El paciente NO puede editar obra social ni campos clínicos sensibles desde el portal
- [x] **PORTAL-05**: En "Información de salud", el paciente auto-reporta adicciones/drogas, enfermedades y tratamientos previos relacionados a la cirugía
