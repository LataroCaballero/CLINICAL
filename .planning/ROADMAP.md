...
Plans:
- [ ] 03-01: Backend — PDF generation con PDFKit (PresupuestoPdfService) + documentos-queue BullMQ
- [ ] 03-02: Backend — endpoints marcarEnviado + rechazar con motivo + transiciones CRM-03 y CRM-04
- [ ] 03-03: Frontend — flujo completo: crear presupuesto → preview PDF → enviar por email → modal motivo pérdida
...
|-------|----------------|--------|-----------|
| 1. Infraestructura Async | 0/3 | Not started | - |
