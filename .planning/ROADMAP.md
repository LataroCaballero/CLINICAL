...
<details>
<summary>✅ v1.13 Embudo CRM Accionable (Fases 57–60) — SHIPPED 2026-07-05</summary>

**Goal:** Volver el embudo CRM accionable y ordenado en su tramo post-consulta — el stepper del sheet lateral resuelve cada pendiente de un click, Confirmado/post-cirugía quedan bien clasificados, y las estadísticas se apoyan en cirugías/tratamientos reales.

- [x] Phase 57: Backend Foundation — Etapa y Payload Enriquecido (2/2 planes) — completado 2026-07-04
- [x] Phase 58: Kanban Board — Columnas, Tarjetas y Etiquetas (1/1 plan) — completado 2026-07-04
- [x] Phase 59: Stepper Accionable (3/3 planes) — completado 2026-07-05
- [x] Phase 60: Estadísticas sobre Registros Reales (2/2 planes) — completado 2026-07-05
...
- [x] **Phase 65: Sync Tipo de Turno ↔ Plantilla HC (Backend)** - El tipo de turno se ajusta automáticamente según la plantilla de HC cargada (completed 2026-08-04)
...
- [x] 63-02-PLAN.md — EMBUDO-08: CONFIRMADO al agendar cirugía, guard selectivo de degradación (Consulta), recontacto de cirugía cancelada
...
- [x] 64-01-PLAN.md — TRAT-07 (backend): expone `tratamientos: string[]` completo en /turnos/rango (ultimoTratamiento sin cambios)
- [x] 64-02-PLAN.md — CONTACTO-03/04: badge de pendiente "Dar turno"/"Ser atendido" por columnId en PatientCard
...
- [x] 65-01-PLAN.md — HCSYNC-01/02/03: helper resolverTipoTurnoSync (escalera de prioridad) + sync guardado de Turno.tipoTurnoId/esCirugia en crearEntrada
