# Requirements Archive: v1.5 Catálogos Clínicos y Flujos de Atención
...
- [x] **PRESUP-01**: Al armar un presupuesto, el usuario puede seleccionar ítems desde el catálogo de cirugías del profesional
- [x] **PRESUP-02**: Al armar un presupuesto, el usuario puede seleccionar ítems desde el catálogo de tratamientos
- [x] **PRESUP-03**: Al seleccionar un ítem del catálogo, se auto-completan nombre y precio (ARS/USD) como snapshot en el momento de la selección
- [x] **PRESUP-04**: Se pueden seguir agregando ítems de texto libre al presupuesto (comportamiento actual sin cambios)
...
| PRESUP-01 | Phase 28 | Complete |
| PRESUP-02 | Phase 28 | Complete |
| PRESUP-03 | Phase 28 | Complete |
| PRESUP-04 | Phase 28 | Complete |
